...
namespace :data do 
  ...
  task :create_datas => :environment do
   ...
   SizeOfShoe.create([
     {:id => 1, :general_shoe_id => "1",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 2, :general_shoe_id => "2",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 3, :general_shoe_id => "3",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 4, :general_shoe_id => "4",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 5, :general_shoe_id => "5",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 6, :general_shoe_id => "6",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 7, :general_shoe_id => "7",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 8, :general_shoe_id => "8",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 9, :general_shoe_id => "9",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 10, :general_shoe_id => "10",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 11, :general_shoe_id => "11",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 12, :general_shoe_id => "12",:size => "36",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 13, :general_shoe_id => "1",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 14, :general_shoe_id => "2",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 15, :general_shoe_id => "3",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 16, :general_shoe_id => "4",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 17, :general_shoe_id => "5",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 18, :general_shoe_id => "6",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 19, :general_shoe_id => "7",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 20, :general_shoe_id => "8",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 21, :general_shoe_id => "9",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 22, :general_shoe_id => "10",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 23, :general_shoe_id => "11",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 24, :general_shoe_id => "12",:size => "37",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 25, :general_shoe_id => "1",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 26, :general_shoe_id => "2",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 27, :general_shoe_id => "3",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 28, :general_shoe_id => "4",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 29, :general_shoe_id => "5",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 30, :general_shoe_id => "6",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 31, :general_shoe_id => "7",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 32, :general_shoe_id => "8",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 33, :general_shoe_id => "9",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 34, :general_shoe_id => "10",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 35, :general_shoe_id => "11",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
     {:id => 36, :general_shoe_id => "12",:size => "38",:necessary_num => "500",:not_processing_num => "500",:finished_num => "",:store_remaining => ""},
   ])
