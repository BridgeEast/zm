...
ActiveRecord::Schema.define(:version => 20121006082954) do
  ...
  create_table "factory_process_shoes", :force => true do |t|
  ...
  create_table "inbound_and_outbounds", :force => true do |t|
    t.integer  "size_of_shoe_id",           :null => false
    t.integer  "size"
